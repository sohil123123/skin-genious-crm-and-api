...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('assessments', function (Blueprint $table) {
            ...
            $table->string('left_cheek_temp')->nullable()->comment('Left cheek skin temperature');
            $table->string('right_cheek_temp')->nullable()->comment('Right cheek skin temperature');
            ...
            $table->enum('selected_plan_type', ['single', 'express', 'multiple', 'single_session_option_1', 'single_session_option_2', 'budget_option', 'plan_option'])->nullable()->index()->comment('Indicates which treatment plan type (single or multiple) was selected by the user');
