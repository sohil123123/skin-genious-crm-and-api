...
export const COMPACT_PAIRWISE_VERSION = 'aia_pairwise_compact_v3.9.3'
...
const feature = obj({global_change_direction:direction, global_change_confidence:{type:'string',enum:['high','medium','low']}, zones_visibly_improved:strings,zones_visibly_worsened:strings,transient_reactivity_note:string,global_summary:string})
...
export function decodeCompactPairwise(value,input) {
  ...
  return {...value,pairwise_outcome_version:PAIRWISE_OUTCOME_EVIDENCE_V2_VERSION,wire_version:COMPACT_PAIRWISE_VERSION,
    ...
    feature_comparisons:Object.fromEntries(CORE_FEATURE_IDS.map(id=>[id,{...value.feature_comparisons[id],feature_id:id,zones:{},zones_stable:[],detail_scope:'global_direction_with_supporting_zones'}]))}
}
