// Exact source objects; no new clinical thresholds.
export const LEGACY_RUBRIC_V37 = {
  "skin_type_criteria": {
    "metadata": {
      ...
      "notes": "Determines overall skin type based on oiliness, dryness, sensitivity, barrier quality, pore activity, pigment response and sebaceous distribution. No treatment mapping included. Legacy skin-type intent preserved."
    },
    "mode_roles": {
      ...
      "subsurface_polarized": "Subsurface hydration contrast, deeper unevenness, lesion conspicuity support.",
    ...
    "primary_metrics": {
      "sebum_distribution_index": {
        "description": "Oil pattern across T-zone and cheeks using white + surface_polarized, supported by sebum_oiliness helper bins from the feature packet.",
        "range": "0-1",
        "classification": {
          "dry": "<0.25",
      ...
      "hydration_deficit_index": {
        "description": "Dryness fluorescence and micro-flaking burden using woods_uv + surface_polarized, supported by hydration bins from the feature packet.",
        "range": "0-1",
        "classification": {
          "well_hydrated": "<0.25",
      ...
      "pore_activity_index": {
        "description": "Pore visibility, density, and congestion from surface_polarized + white, supported by blackhead_congestion_bin where relevant.",
        "range": "0-1",
        "classification": {
          "minimal": "<0.25",
          "moderate": "0.25-0.55",
      ...
      "barrier_integrity_index": {
        "description": "Barrier strength inferred from woods_uv dry-fluorescence support + combined barrier feature packet fields.",
        "range": "0-1",
        "classification": {
          "strong": "<0.30",
      ...
      "sensitivity_index": {
        "description": "Redness/reactivity patterns from red + white, supported by combined_barrier_sensitivity and redness feature packet fields.",
        "range": "0-1",
        "classification": {
          "low": "<0.30",
          "moderate": "0.30-0.60",
      ...
      "photo_reactivity_index": {
        "description": "woods_uv enhancement relative to white-light visible baseline (photo-reactivity / chronicity support).",
    ...
    "polarity_metadata": {
      ...
      "target_interpretation_rule": "Stable categorical classification; target is to maintain or move only when imaging and feature-packet evidence clearly support a different category."
    },
    "output_format": {
  ...
  "combined_barrier_sensitivity": {
    "metadata": {
      ...
      "notes": "Unified scoring combining barrier integrity + sensitivity reactivity. Vascularity kept separate. Sensitive to treatment-driven changes such as hydration, barrier repair, and inflammation reduction. Core score equation preserved."
    },
    "mode_roles": {
      "white": "Surface dryness, roughness, flaking visibility, visible redness baseline.",
      "surface_polarized": "Texture disruption, micro-cracks, flaky edges, barrier microtexture homogeneity.",
    ...
    "primary_metrics": {
      ...
      "vascular_pattern_index": {
        "description": "Reactive vascular features indicating sensitivity (not chronic generalized redness). Derived from redness + combined_barrier feature packet evidence.",
        "range": "0-1"
      },
    ...
    "backend_indices": {
      ...
      "improvability_index": {
        ...
        "formula": "(hydration_signal_index * 0.4) + (surface_texture_uniformity * 0.3) + (1 - erythema_intensity_index) * 0.3",
        "range": "0-1"
      }
    },
    "combined_index_equation": {
      "description": "Continuous barrier-sensitivity burden value (0-1).",
      "equation": "BSI = 0.30*(1 - surface_texture_uniformity) + 0.25*(1 - hydration_signal_index) + 0.25*erythema_intensity_index + 0.10*vascular_pattern_index + 0.10*flaking_texture_index"
    },
    "score_bins": {
      "1": {
        "range": "<0.20",
  ...
  "visual_acne_scoring": {
    "metadata": {
      ...
      "notes": "Scale 1-5 where 1 = minimal acne and 5 = severe/nodulocystic. Includes spatial maps & per-lesion coordinates for treatment-level intelligence. Core ASI distribution preserved. New helper bins are consumed from the feature packet."
    },
    "lesion_types": {
      "open_comedone": {
        "description": "Visible dark comedones, strongest in surface_polarized + white; minimal inflammation.",
        "weight": 0.18
      },
      "closed_comedone": {
      ...
      "pustule": {
        "description": "Papule with purulent center; best confirmed in white and subsurface_polarized with inflammatory support from red.",
        "weight": 0.24
      },
      "nodule": {
        "description": "Deep painful lesions with deeper inflammatory prominence; supported by subsurface_polarized + red + woods_uv chronicity context.",
        "weight": 0.14
      }
    },
    "region_weights": {
    ...
    "primary_metrics": {
      ...
      "chronicity_index": {
        "description": "Post-acne/chronic burden using woods_uv + white support and post_inflammatory_mark_burden_bin.",
        "range": "0-1"
      }
    },
    "backend_indices": {
        ...
        "format": [
          {
            ...
            "region": "forehead | cheek_left | cheek_right | nose | chin | jawline_left | jawline_right",
      ...
      "BIBI_index": {
        "description": "Global Bacterial + Inflammatory Burden Index. Higher values indicate high porphyrin load + high inflammatory lesion ratio.",
        "formula": "(0.6 * uv_porhyrin_load) + (0.4 * inflammatory_ratio)",
        "range": "0-1",
        "clinical_relevance": "High BIBI directs AI engine toward antibacterial, anti-inflammatory, keratolytic and bacteriostatic treatments."
      }
    },
    "normalization_logic": {
      ...
      "inflammation_normalized": {
        "method": "Use inflammatory_ratio directly."
      },
      "clusters_normalized": {
    ...
    "acne_severity_equation": {
      ...
      "equation": "ASI = 0.40*lesion_load_normalized + 0.30*inflammation_normalized + 0.15*comedone_density_index + 0.15*inflammatory_cluster_index"
    },
    "grading_scale": {
      "1": {
        "range": "<0.20",
  ...
  "sebum_content_scoring": {
    "metadata": {
      ...
      "notes": "Score reflects clinically visible oiliness, subclinical sebaceous activity, bacterial porphyrins, and shine dynamics. Designed to be treatment-responsive. Core SSI equation and score bins preserved."
    },
    "mode_roles": {
      ...
      "subsurface_polarized": "Deeper sebaceous activity support and oily-shadow differentiation when needed.",
    ...
    "primary_metrics": {
      ...
      "sebum_fluorescence_index": {
        "description": "Follicular / sebaceous activity support using woods_uv + surface_polarized evidence family.",
    ...
    "backend_indices": {
      ...
      "bacterial_inflammatory_burden_index": {
        "description": "Combined measure of bacterial activity + inflammation derived from porphyrin support and follicular inflammatory congestion.",
        "components": {
          "bacterial_component": {
          ...
          "subclinical_inflammation_component": {
            ...
            "weight": 0.45,
            "description": "Contribution from follicular blockage + inflammatory fluorescence/congestion patterns."
          }
        },
        "final_equation": "BIBI = (0.55 * porphyrin_load_index) + (0.45 * ((sebum_fluorescence_index * 0.6) + (sebaceous_congestion_index * 0.4)))",
        "output_range": "0-1"
      }
    },
    "normalization_logic": {
    ...
    "sebum_burden_equation": {
      ...
      "equation": "SSI = 0.40*shine_norm + 0.25*fluorescence_norm + 0.20*porphyrin_norm + 0.15*congestion_norm"
    },
    "score_bins": {
      "1": {
        "range": "<0.20",
  ...
  "vascularity_redness_scoring": {
    ...
    "core_parameters": {
      ...
      "vascular_pattern_prominence": {
        "description": "Visibility of linear/telangiectatic vessel-like structure in red-supported vascular view.",
        "lighting": [
          "red",
          "subsurface_polarized"
        ],
    ...
    "backend_output": {
      ...
      "global_vascularity_redness_score": "Final score (1-5 based on clinical hierarchy, not averaging)",
      "BIBI_index": {
        ...
        "components": {
          ...
          "sebaceous_inflammation_component": "Red + woods_uv + surface_polarized acne-linked inflammatory support (0-1)"
        },
        "formula": "BIBI = 0.45*porphyrin_component + 0.35*deep_inflammation_component + 0.20*sebaceous_inflammation_component",
        "range": "0-1"
      }
    },
    "decision_logic": {
  ...
  "skin_hydration_scoring": {
    "metadata": {
      ...
      "notes": "Score reflects surface hydration, micro-line density, diffusion quality, dullness, and dryness patterns. Fully treatment-responsive and patient-perception aligned. Core HSI equation preserved."
    },
    "mode_roles": {
    ...
    "backend_indices": {
      ...
      "barrier_compromise_index": {
        "description": "Barrier dysfunction from dehydration using combined_barrier + hydration feature packet evidence.",
        "range": "0-1"
      },
    ...
    "hydration_burden_equation": {
      ...
      "equation": "HSI = 0.40*surface_reflectance_index + 0.25*subsurface_diffusion_index + 0.15*(1 - microline_density_index) + 0.10*sebum_balance_ratio + 0.10*(1 - dry_patch_fluorescence_index)"
    },
    "score_bins": {
      "1": {
        "range": "<0.30",
  ...
  "skin_luminosity_index": {
    "metadata": {
      ...
      "notes": "Measures surface glow, subsurface translucency, brightness, uniformity, dryness/shadow contrast. Fully treatment-responsive. Core GLI equation preserved."
    },
    "mode_roles": {
    ...
    "backend_indices": {
      ...
      "treatment_responsiveness_index": {
        ...
        "formula": "0.5*(1 - dryness_dullness_index) + 0.3*sebum_gloss_index + 0.2*(subsurface_diffusion_index)",
        "range": "0-1"
      }
    },
    "index_equation": {
      "description": "Weighted luminosity equation (0-1)",
      "equation": "GLI = 0.30*surface_reflectance_uniformity + 0.25*color_luminance_index + 0.20*subsurface_diffusion_index + 0.15*shadow_softness_index + 0.05*sebum_gloss_index + 0.05*(1 - dryness_dullness_index)"
    },
    "score_bins": {
      "1": {
        "range": "<0.25",
  ...
  "superficial_pigmentation_scoring": {
    "metadata": {
      ...
      "notes": "Score reflects perceived superficial pigment burden in real-life lighting and is designed to be treatment-relevant, sensitive to change, and spatially precise for localized treatments. Core PPL equation and score bins preserved."
    },
    "mode_roles": {
      "white": "Visible pigmentation and unevenness as perceived by patient; primary driver of clinical score.",
    ...
    "primary_metrics": {
      ...
      "border_definition_score": {
        "description": "Sharpness of lesion edges derived from surface_polarized/subsurface_polarized support; 0-1 (0 = indistinct, 1 = sharply demarcated)."
      }
    },
    "backend_indices": {
      "depth_index_uv_to_woods": {
        "description": "Legacy-preserved depth proxy name. In the 5-mode system this is computed as a closest-compatible pigment-depth proxy using woods_uv support versus visible intensity.",
        "formula": "depth_support / (visible_support + 0.001)",
        "range": "0-2"
      },
      "melanin_chroma_separation_index": {
        "description": "Legacy-preserved chroma-separation proxy name. In the 5-mode system this estimates pigment-versus-redness separation using pigment-support vs redness-support evidence.",
        "formula": "(pigment_support - redness_support) / (pigment_support + redness_support + 0.001)",
        "range": "-1 to +1"
      },
      ...
      "uv_enhancement_ratio": {
        "description": "Legacy-preserved chronicity/photo-damage proxy name. In the 5-mode system this is computed from woods_uv support relative to visible burden.",
        "formula": "woods_uv_support / (white_support + 0.001)",
        "range": "0-2"
      },
      "superficial_fraction_index": {
        "description": "Proportion of total pigment signal likely superficial/epidermal and therefore more treatment-responsive.",
        "formula": "1 - normalized_depth_indicator_ratio",
        "range": "0-1"
      },
      "improvability_index": {
        "description": "Heuristic measure of how much of the pigment burden is realistically improvable in the short-to-medium term.",
      ...
      "pigment_grid_map": {
        "description": "Hybrid anatomical 6\u00d74 grid of superficial pigment intensity for precise spot treatments.",
        "components": {
          "grid_size": "[rows, columns] \u2192 [4, 6]",
          "grid_values": "2D array [4][6] with each cell as float 0-1 representing normalized superficial pigment intensity."
        }
      }
    },
    "scoring_logic": {
      "description": "Determines a perceived pigment load score (1-5) without population-based Gaussian normalization, while being sensitive to mottling and regional variation.",
      "normalization": {
      ...
      "perceived_pigment_load_equation": {
        "description": "Core continuous load metric (0-1). Visible intensity and contrast are allowed to drive score change even when pigment distribution remains broadly similar after treatment.",
        "equation": "PPL = 0.25 * coverage_area_normalized + 0.40 * mean_intensity_normalized + 0.15 * contrast_to_surrounding_skin_normalized + 0.15 * woods_cluster_normalized + 0.05 * ((uniformity_penalty + region_variation_index) / 2)"
      },
      "score_bins": {
        "1": {
          "range": "<0.18",
      ...
      "reassessment_response_logic": {
        "description": "Allows subtle but real post-treatment pigment lightening to register even when patch geography is largely unchanged.",
        "inputs_required": [
        ...
        "delta_definitions": {
          ...
          "delta_contrast": "before.contrast_to_surrounding_skin_normalized - after.contrast_to_surrounding_skin_normalized",
        ...
        "pigment_response_index": {
          "description": "Composite reassessment improvement metric emphasizing visible lightening over mere redistribution.",
          "equation": "PRI = 0.50*delta_intensity + 0.25*delta_contrast + 0.15*delta_woods_cluster + 0.10*delta_coverage"
        }
      },
      "steps": [
  ...
  "peri_orbital_skin_health_scoring": {
    "metadata": {
      "device": "Bitmoji A5 Analyzer",
      "lighting_modes_used": [
        "red",
    ...
    "scoring_parameters": {
      ...
      "vascular_visibility": {
        "description": "Purple/red vascular tint enhanced under red and subsurface_polarized support.",
  ...
  "lip_pigmentation_scoring": {
    "metadata": {
      ...
      "version": "4.0",
      "notes": "Built to detect melanin-based and vascular-based lip darkening even when cosmetic masking is present. Core intent preserved."
    },
    "mode_roles": {
  ...
  "texture_pores_scoring": {
    "metadata": {
      ...
      "notes": "Texture and open pores score aligned to feature_packet.pores_texture and pores_texture_plus."
    },
    "core_metrics": {
      "pore_density_index": {
    ...
    "equation": {
      ...
      "formula": "PTI = 0.30*pore_density_index + 0.25*pore_diameter_index + 0.20*(1-pore_clarity_index) + 0.15*texture_roughness_index + 0.10*blackhead_congestion_index"
    },
    "score_bins": {
      "1": {
        "range": "<0.18",
  ...
  "superficial_wrinkles_scoring": {
    "metadata": {
      ...
      "notes": "Wrinkle burden consumes feature_packet.wrinkles and wrinkles_plus. Legacy severity bins preserved."
    },
    "core_metrics": {
      "wrinkle_line_count": {
    ...
    "equation": {
      ...
      "formula": "WBI = 0.30*wrinkle_depth_index + 0.20*microline_density_index + 0.15*chronicity_uv_index + 0.15*(1-regional_uniformity_index) + 0.20*structural_vs_dehydration_index"
    },
    "score_bins": {
      "1": {
        "range": "<0.18",
  ...
  "jawline_sagging_scoring": {
    "metadata": {
      ...
      "notes": "Measures lower-face contour integrity, soft-tissue descent, pre-jowl sulcus depth, and submental heaviness. Core intent preserved; now consumes feature_packet.jawline_sagging."
    },
    "mode_roles": {
      "white": "Visible contour shape, sag visibility, jowl prominence.",
      "surface_polarized": "Shadow-edge and contour transition support for sag depth and angle deflection.",
  ...
  "skin_firmness_elasticity_index": {
    ...
    "equation": {
      ...
      "formula": "FI = (0.40*micro_laxity_pattern_index) + 0.35*(1-collagen_reflectance_uniformity) + 0.25*(1-elastic_recoil_proxy_index)"
    },
    "polarity_metadata": {
      "score_semantics": "severity",
      "score_polarity": "higher_is_worse",
  ...
  "textural_radiance_index": {
    ...
    "equation": {
      ...
      "formula": "TRI = 0.40*(1-micro_clarity_index) + 0.35*(1-surface_smooth_scatter_index) + 0.25*(keratin_shadow_index)"
    },
    "polarity_metadata": {
      "score_semantics": "severity",
      "score_polarity": "higher_is_worse",
