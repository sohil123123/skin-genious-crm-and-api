        ...
        return $schema
            ->schema([
                Section::make('Basic Information')
                    ...
                    ->schema([
                        TextEntry::make('manager.name')->label('Manager')->placeholder('N/A'),
                ...
                Section::make('Address Details')
                    ...
                    ->schema([
                        ...
                        TextEntry::make('address_line2')->label('Address Line 2')->placeholder('N/A'),
                        TextEntry::make('pincode')->label('Pincode'),
                ...
                Section::make('Contact Information')
                    ...
                    ->schema([
                        ...
                        TextEntry::make('email')->label('Email')->placeholder('N/A'),
                ...
                Section::make('Financial Details')
                    ...
                    ->schema([
                        TextEntry::make('gst_number')->label('GST Number')->placeholder('N/A'),
                        // TextEntry::make('first_sale_share')
                        //     ->label('First Sale Share')
                        //     ->suffix('%'),
                        TextEntry::make('sale_share')->label('Sale Share')->suffix('%'),
                    ])
                    ->columns(3)
                    ->collapsible(),
