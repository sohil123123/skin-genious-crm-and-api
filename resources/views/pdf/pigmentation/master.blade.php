...
html, body {
    margin: 0;
    padding: 0;
    font-family: montserratreportv36, dejavusans, sans-serif;
    font-size: 8.2pt;
    line-height: 1.32;
    color: #eef6fb;
    background-color: #061421;
...
.cover-title { font-family: playfairreportv36, dejavuserif, serif; font-size: 29pt; line-height: 1.0; color: #f5f7fa; }
.cover-kicker { font-size: 12.2pt; color: #ced8df; margin-top: 1.1mm; }
...
.section-title { margin-top: 0.4mm; font-family: playfairreportv36, dejavuserif, serif; font-size: 20.5pt; line-height: 1.06; color: #ffffff; }
...
.metric-number { font-size: 31pt; line-height: 1; color: #ffffff; font-weight: bold; }
...
.image-box { background-color: #050e18; border: 0.28mm solid #2c5268; padding: 1mm; text-align: center; }
.mode-label { font-size: 6.3pt; font-weight: bold; line-height: 1.18; text-align: center; }
.snapshot-label { display:block; min-height:7.4mm; font-size:6.15pt; line-height:1.18; font-weight:bold; text-align:center; margin-bottom:1.1mm; }
.snapshot-cell { text-align:center; vertical-align:top; }
...
.journey-line { border-top: 0.45mm solid #486680; }
</style>
</head>
<body>
<htmlpagefooter name="pigFooter">
...
<td width="27%"><div class="footer-label">Report Type</div><div class="footer-value">Pigmentation Diagnosis</div></td>
<td width="25%"><div class="footer-label">Analysis Method</div><div class="footer-value">5-Mode Skin Imaging</div></td>
...
<sethtmlpagefooter name="pigFooter" value="on" show-this-page="1" />
@yield('content')
</body>
</html>
